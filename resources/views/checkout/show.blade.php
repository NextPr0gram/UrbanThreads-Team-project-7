    ...
    @auth
        <div class="sm:grid lg:grid-cols-2 lg:px-20 xl:px-32">
            ...
            <div class="sm:px-4 sm:pt-8">
                <div class="p-3 mt-2 space-y-3 w-full bg-white bg-opacity-60 border-2 sm:px-6 border-navy-blue max-sm:text-center">
                ...
                <div class="p-4 mt-5 space-y-6 bg-white bg-opacity-60 border-2 border-navy-blue">
                    ...
                    <div class="flex flex-col items-center mt-2 sm:flex-row sm:space-x-6">
                        <div class="w-full">
                            ...
                            <x-text-input type="text" id="first_name" name="first_name" class="w-full text-sm shadow-sm font-lexend"
                                placeholder="John"/>
                        </div>
                        <div class="pt-6 w-full sm:pt-0">
                            <x-input-label for="last_name">Last Name</x-input-label>
                            <x-text-input type="text" id="last_name" name="last_name" class="w-full text-sm shadow-sm"
                                placeholder="Doe"/>
                        </div>
                    </div>
