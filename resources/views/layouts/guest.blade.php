<x-app-layout>
    <div class="flex items-center py-32 sm:justify-center sm:pt">
        ...
        <div class="overflow-hidden px-6 py-4 mt-6 w-full bg-white bg-opacity-40 border-2 shadow-md backdrop-blur-sm sm:max-w-md b border-primary-300 rounded-lg">
