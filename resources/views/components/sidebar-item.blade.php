...
@props(['href', 'title', 'forLogout' => false])
        ...
        @auth
            <form method="POST" action="{{ route('logout') }}">
                ...
                <a :href="route('admin.logout')"
                    ...
                    <div
                        class="my-[5px] h-10 group flex items-center duration-150 ease-in-out rounded-sm active:bg-secondary-50  hover:bg-secondary-100 hover:text-secondary-500  text-neutral-30  bg-white">
                        ...
                        <div class="aspect-square pl-4 pr-2 rounded-sm flex items-center justify-cente ">
                            ...
                            <img class="block group-active:hidden  "
                                src="{{ asset('icons/admin-dashboard/bar-chart-icon-white.svg') }}" alt="">
                            <img class="hidden group-active:block"
