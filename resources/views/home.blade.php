<x-app-layout>
    ...
    <div class="ml-12 text-black font-medium font-lexend leading-normal relative"> <!-- text-sm -->
        ...
        <h2 class="mb-4 ml-4 flex flex-wrap 2xl:hidden">
            <span class="absolute left-0 inline-block px-0.5 ml-1 w-0.5 h-8 bg-bluish-purple"></span>
            <div style="padding-top:4px">Elevate Your Style. </div>
    ...
    <div class="flex flex-wrap items-center justify-evenly" style="margin-top: 300px; margin-bottom: 150px">
        ...
        <div class="inline-flex justify-center items-center w-64 h-96 bg-snow-white mb-9">
            <!-- sm:flex-col sm:gap-7 sm:mb-0 -->
            <a href="/product1">
                <h1 class="text-black font-formula13xl leading-normal font-medium px-6 py-6">Product 1</h1>
        </div>

        <!-- Container for second product -->
        <div class="inline-flex justify-center items-center gap-2.5 w-64 h-96 bg-snow-white mb-9">
            <!-- sm:flex-col sm:mb-0 -->
            <a href="/product2">
