...
<x-app-layout>
    ...
    <div class="flex justify-between items-center lg:px-10">
        ...
        <div class="py-10 pl-4">
            <h1 class="px-2 my-5 text-3xl leading-tight text-default-transparent bg-clip-text bg-gradient-to-r from-primary-300 to-secondary-300 font-formula1 sm:text-4xl lg:text-6xl">
                Welcome to <br>
                UrbanThreads
            </h1>
